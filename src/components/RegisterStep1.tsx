    ...
    <div>
      <form action="flex flex-cols gap-3" onSubmit={submitHandler} autoComplete="off">
        ...
        <div className="form-controll">
          <input type="submit" value={"Continue"} className="text-white cursor-pointer text-base p-4 rounded-md mb-4 transition-colors duration-300 bg-opred hover:bg-opredHover focus:bg-opredHover active:bg-opredHover  w-full text-center block" />
          {message.length > 1 &&
